	...
	foreach ($events['events'] as $event) {
		...
		if ( ($event['type'] == 'message' && $event['message']['type'] == 'text' ) || $join == 1) {
			...
			$question = [
				...
				66 => [
					'keywords' => 'บอกรัก',
					'ans' => 'รักนุชเชสมากมายที่สุดในโลก ชีวิต จักรวาล บอโร่ ตอเซ่ สวิชดาวน์ 702 เลยแหละ'
				],
				67 => [
					'keywords' => 'ว๊อย',
					'ans' => 'เก้วกาดหลอออออออ'
				],
				68 => [
					'keywords' => 'แก่',
					'ans' => 'เชบบผรวดด'
				...
				70 => [
					'keywords' => 'กวน'
					'ans' => 'ขอโทษที่เอาแต่ใจ ไม่ใช่เวลามาง้อๆกัน'
				],
				71 => [
					'keywords' => 'โทษ'
					'ans' => 'โทษเฮียไม่ได้นะคร๊อป'
				]
